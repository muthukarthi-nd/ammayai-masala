        ...
        return i = n(r), f = t.call(r, "ontouchstart") >= 0, s = {
            ...
            function t(t) {
                ...
                this.$element = t, this.element = t[0], this.didResize = !1, this.didScroll = !1, this.id = "context" + c++, this.oldScroll = {
                    ...
                    horizontal: {},
                    vertical: {}
                }, t.data(a, this.id), u[this.id] = this, t.bind(y, (function() {
                    var t;
            ...
            return t.prototype.doScroll = function() {
                ...
                return t = {
                    ...
                    return l = [], o = r.newScroll > r.oldScroll, i = o ? r.forward : r.backward, n.each(e.waypoints[t], (function(t, e) {
                        var n, i;
                        return r.oldScroll < (n = e.offset) && n <= r.newScroll || r.newScroll < (i = e.offset) && i <= r.oldScroll ? l.push(e) : void 0
                    })), l.sort((function(t, e) {
                ...
                return r = n.isWindow(this.element), e = this.$element.offset(), this.doScroll(), t = {
                    ...
                    return n.each(i.waypoints[t], (function(t, r) {
                        var i, o, l, s, c;
                        if (i = r.options.offset, l = r.offset, o = n.isWindow(r.element) ? 0 : r.$element.offset()[e.offsetProp], n.isFunction(i) ? i = i.apply(r.element) : "string" == typeof i && (i = parseFloat(i), r.options.offset.indexOf("%") > -1 && (i = Math.ceil(e.contextDimension * i / 100))), r.offset = o - e.contextOffset + e.contextScroll - i, (!r.options.onlyOnScroll || null == l) && r.enabled) return null !== l && l < (s = e.oldScroll) && s <= r.offset ? r.trigger([e.backward]) : null !== l && l > (c = e.oldScroll) && c >= r.offset || null === l && e.oldScroll >= r.offset ? r.trigger([e.forward]) : void 0
                    }))
                }))
            }, t.prototype.checkEmpty = function() {
                if (n.isEmptyObject(this.waypoints.horizontal) && n.isEmptyObject(this.waypoints.vertical)) return this.$element.unbind([p, y].join(" ")), delete u[this.id]
            }, t
        }(), l = function() {
            function t(t, e, r) {
                var i, o;
            ...
            init: function(t, e) {
                return null == e && (e = {}), null == e.handler && (e.handler = t), this.each((function() {
                    var t, r, i, s;
                    return t = n(this), i = null != (s = e.context) ? s : n.fn[g].defaults.context, n.isWindow(i) || (i = t.closest(i)), i = n(i), (r = u[i.data(a)]) || (r = new o(i)), new l(t, r, e)
                })), n[S]("refresh"), this
            },
            disable: function() {
